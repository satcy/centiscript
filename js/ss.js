...
,'sz(1720,720)bg(0)frame(){num=(50)for(j,0,5){for(i,0,num){r=((nz(i*0.1,c*0.003)+1)*w/3)rad=((PI2/num)*i+c/283)x=(cos(rad)*r)y=(sin(rad)*r)r=((nz(((i+1)%num)*0.1,c*0.003)+1)*w/3)rad=((PI2/num)*(i+1)+c/283)x2=(cos(rad)*r)y2=(sin(rad)*r)col((c*0.25)%255)line(x+cx,y+cy,x2+cx,y2+cy)}c++;}c--;}'
...
,'sz(1280,720)frame(){clear()for(i,0,327){col(255)x=(w/2)y=(h/2)line(cos(c*0.04+i*0.003)*x+x,sin(c*0.03+i*0.013)*y+y,cos(c*0.032+i*0.013)*x+x,sin(c*0.054+i*0.012)*y+y)}}'
